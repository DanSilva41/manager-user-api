...
-- MARKETING
INSERT INTO backing.department (code, name, description, version, created_at, updated_at)
VALUES (2, 'MARKETING', 'Setor responsável pelas mídias sociais e marca da empresa', 1,
        '2024-06-27 15:18:25.977576 +00:00',
...
-- Paul Walker
INSERT INTO backing.person (code, first_name, last_name, email, version, created_at, updated_at)
VALUES (2, 'Paul', 'Walker', 'paul.walker@gmail.com', 1, '2024-06-27 18:51:25.977576 +00:00',
        '2024-06-27 18:51:25.977672 +00:00');

INSERT INTO security."user" (code, username, password, active, person_code, department_code, version, created_at,
                             updated_at)
VALUES (2, 'paulwalker', 'p@ssw0rd', true, 2, 2, 1, '2024-06-27 18:51:25.985665 +00:00',
        '2024-06-27 18:51:25.985683 +00:00');
